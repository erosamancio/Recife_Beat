...
const MusicaInfo catalogo[NUM_MUSICAS] = {
    {"A PRAIEIRA", "CHICO CIENCE", "audio/a_praieira.ogg", "mapas/mapa_praieira.txt", "rankings/ranking_praieira.txt", "CABULOSO", RED},
    {"ANUNCIAO", "ALCEU VALENCA", "audio/anunciacao.ogg", "mapas/mapa_anunciacao.txt", "rankings/ranking_anunciacao.txt", "ARRETADO", ORANGE},
    ...
    {"LEAO DO NORTE" , "LELINE", "audio/leao_do_norte.ogg", "mapas/mapa_leao_do_norte.txt", "rankings/ranking_leao_do_norte.txt", "ARRETADO", ORANGE},
    {"VOLTEI RECIFE", "ALCEU VALENCA", "audio/voltei_recife.ogg", "mapas/mapa_voltei_recife.txt", "rankings/ranking_voltei_recife.txt", "CABULOSO", RED}
};
